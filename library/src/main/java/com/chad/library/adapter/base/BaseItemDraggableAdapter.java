 ...
 */
public abstract class BaseItemDraggableAdapter<T, K extends com.chad.library.adapter.base.BaseViewHolder> extends com.chad.library.adapter.base.BaseQuickAdapter<T, K> {
    ...
    public void onBindViewHolder(K holder, int positions) {
        ...
        if (mItemTouchHelper != null && itemDragEnabled && viewType != LOADING_VIEW && viewType != HEADER_VIEW
            ...
            if (mToggleViewId != NO_TOGGLE_VIEW) {
                View toggleView = ((com.chad.library.adapter.base.BaseViewHolder) holder).getView(mToggleViewId);
                if (toggleView != null) {
